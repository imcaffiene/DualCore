...
const WHATSAPP_NUMBER = "918434262589";
const PROJECT_TYPES = [
  "AI agent / Automation",
  "Full-stack app",
  "Website",
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid gap-16 lg:grid-cols-2">
          ...
          >
            ...
            <h2 className="mt-4 font-heading text-5xl font-bold sm:text-6xl">
                            ...
                            <div role="listbox" aria-labelledby="projectType" className="space-y-1">
                              {PROJECT_TYPES.map((option) => (
                                <button
                                  ...
                                  className={`flex w-full items-center rounded-xl px-3 py-2.5 text-left text-sm transition-colors ${form.projectType === option ? "bg-white/8 text-foreground" : "text-foreground/70 hover:bg-white/5 hover:text-foreground"}`}
                                >
                                  {option}
                                </button>
                              ))}
